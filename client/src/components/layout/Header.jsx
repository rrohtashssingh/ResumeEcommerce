                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <div className="cart_user ml-3 flex gap-2 items-center justify-center">
                            ...
                            <Link to={'/register'} className="user p-2 rounded-full border border-white ">
                    ...
                    <div className="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-search">
                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                            ...
                            <li>
                                <NavLink to="/Contact" className="block py-2  hover:text-blue-500  text-white rounded">Services</NavLink>
                            </li>
                            <li>
                                <NavLink to="/PageNotFound" className="block  hover:text-blue-500 py-2 text-white rounded">Services</NavLink>
                            </li>
                            <li>
                                <NavLink to="/" className="block py-2 hover:text-blue-500 text-white rounded">Services</NavLink>
                            </li>
                        </ul>
                    </div>
                </div>

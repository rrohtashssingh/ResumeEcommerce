    ...
    return (
        <Layout title={'Register User'}>
            <div className="form h-full flex justify-center items-center flex-col gap-2">
                ...
                <form onSubmit={handleSubmit} className="max-w-md border-2 border-blue-500 p-5 rounded-md mt-5 mx-auto">
                    <div className="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            <input type="text" name="repeat_password" onChange={(e) => setAddress(e.target.value)} value={address} id="address" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
